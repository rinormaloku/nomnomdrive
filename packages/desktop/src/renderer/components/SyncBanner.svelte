<script lang="ts">
  import { stats, syncProgress } from '../lib/stores';
</script>

<!-- Idle banner -->
<div class="sync-banner" id="sync-banner">
  <div class="sync-banner-idle">
    <div class="sync-status-row">
      <div class="bot-mini bot-idle">
        <svg viewBox="0 0 344 344" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <filter id="bIdleSh" x="-10%" y="-10%" width="120%" height="130%">
              <feDropShadow dx="0" dy="2" stdDeviation="4" flood-opacity=".10" />
            </filter>
          </defs>
          <g class="bot-head" filter="url(#bIdleSh)">
      ...
      <div class="sync-idle-text">
        <span class="sync-label">Up to date</span>
